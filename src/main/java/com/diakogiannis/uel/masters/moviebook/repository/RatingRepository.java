...
public interface RatingRepository extends JpaRepository<Rating, Long> {
    ...
    @QueryHints(value = {@QueryHint(name = org.hibernate.jpa.QueryHints.HINT_READONLY, value = "true")})
    @Query("select new com.diakogiannis.uel.masters.moviebook.model.dto.MovieRatingDTO(r.user.username, r.movie.movieId, r.isLike) from Rating r where r.user.username = :username ")
