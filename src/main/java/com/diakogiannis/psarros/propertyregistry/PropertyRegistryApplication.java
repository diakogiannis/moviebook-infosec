...
public class PropertyRegistryApplication {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PropertyRegistryApplication.class);
    @Autowired
    ...
    ApplicationRunner init(MovieRepository movieRepository, RatingRepository ratingRepository) {
        final ApplicationRunner applicationRunner = args -> {
            ...
            //Make user admin
            userService.updateAuthority(RolesEnum.ROLE_ADMIN.toString(),"vntais");
